      ...
      <div className="flex-1 overflow-y-auto p-4 relative" style={{ scrollBehavior: "smooth" }}>
        {!traceRouteId ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-6">
            <svg className="w-16 h-16 text-[#2a2a2e] mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-[11px] text-[#555] leading-relaxed max-w-[240px]">
              Choose a route from the dropdown above to start simulating requests and exploring the trace flow
            </p>
          </div>
        ) : (
          <>
